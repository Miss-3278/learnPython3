...
print("Hens " + str(float(25 + 30 / 6))) # 打印 Hens, 并把数学公式计算出来的数值转换为字符串，一起打印
print("Roosters " + str(float(100 - 25 * 3 % 4))) 
...
print("What is 3 + 2? " + str(float(3 + 2)))
print("What is 5 - 7? " + str(float(5 - 7)))
